...
const emit = defineEmits<{ scan: [content: string] }>()
...
function handleFile(event: Event) {
  ...
  reader.onload = () => {
    if (typeof reader.result === 'string') emit('scan', reader.result)
  }
...
<template>
  <div class="upload-zone" @dragover.prevent @drop="handleDrop">
    ...
    <p>Drop your <strong>package.json</strong> here</p>
    <span class="or">or</span>
    <label class="file-btn">
      Browse file
      <input type="file" accept=".json" hidden @change="handleFile">
    </label>
